 ...
 *    8base invoke-local myNewTask -p src/resolvers/myNewTask/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local myNewTask -m request
 *
 ...
 *    8base generate mock myNewTask -m [MOCK_FILE_NAME]
 */
