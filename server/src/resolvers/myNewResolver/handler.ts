 ...
 *    8base invoke-local myNewResolver -p src/resolvers/myNewResolver/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local myNewResolver -m request
 *
 ...
 *    8base generate mock myNewResolver -m [MOCK_FILE_NAME]
 */
